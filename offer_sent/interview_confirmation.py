...
OUTPUT_CSV = "E:\\Synthetic-Email-Generation-tool-main\\offer_sent\\offer_sent.csv"
DEBUG_DIR = "E:\\Synthetic-Email-Generation-tool-main\\offer_sent\\debug"
LOG_FILE = "E:\\Synthetic-Email-Generation-tool-main\\offer_sent\\offer_sent_history.log"  # <--- NEW LOG FILE
NUM_EMAILS = 600       
DELAY_SECONDS = 0.1      
MAX_RETRIES = 3          
...
BASE_USER_PROMPT = """Generate a realistic job offer email sent FROM a company TO a candidate.
This email is sent after the candidate has successfully completed all interview rounds.

CONTEXT:
- The offered position is {role}
...
- Clearly congratulate the candidate on receiving the offer
- State that the company is pleased to extend a formal job offer
- Mention that detailed offer information (compensation, joining date, benefits) is included or attached
- Ask the candidate to review the offer and respond with their decision
- Do NOT mention interview feedback details
- Do NOT include onboarding steps
- Professional, positive, ATS-style tone
...
Congratulations! We are pleased to extend an offer for the Software Engineer position at Vertex Technologies.

After completing our interview process, we are confident that your skills and experience will be a valuable addition to our team. Please find the detailed offer letter attached, which outlines the compensation, benefits, and proposed start date.

We kindly request that you review the offer and share your decision by the mentioned deadline. Should you have any questions, feel free to reach out.
...
TONE: Professional, positive, and welcoming

INTENT: Extend a formal job offer and request candidate decision
