...
OUTPUT_CSV = "E:\\Synthetic-Email-Generation-tool-main\\general_Enquiry\\general_Enquiry.csv"
DEBUG_DIR = "E:\\Synthetic-Email-Generation-tool-main\\general_Enquiry\\debug"
LOG_FILE = "E:\\Synthetic-Email-Generation-tool-main\\general_Enquiry\\general_Enquiry_history.log"  # <--- NEW LOG FILE
NUM_EMAILS = 700       
DELAY_SECONDS = 0.1      
MAX_RETRIES = 3          
...
BASE_USER_PROMPT = """Generate a realistic general inquiry acknowledgment email sent FROM a company TO an external sender.
This email is sent in response to a general question or inquiry received by the HR or recruitment team.

CONTEXT:
- The inquiry is related to the {role} position
- The sender described themselves as {adjective}

REQUIREMENTS:
- Invent realistic fictional names for the sender and HR representative
- The sender name and HR representative name MUST be different in every email
- Do NOT reuse the same sender or HR names across emails
- Thank the sender for reaching out with their inquiry
- Acknowledge receipt of the question or message
- State that the inquiry is being reviewed
- Indicate that a response will be provided soon
- Do NOT confirm any hiring decisions
- Do NOT schedule interviews
- Professional, polite, ATS-style tone
...
SUBJECT: Acknowledgment of Your Inquiry | Business Analyst Position

BODY:
Dear Kunal Mehra,

Thank you for contacting us regarding your inquiry about the Business Analyst position.

We have received your message and it is currently under review by our recruitment team. We appreciate your interest and will provide you with a detailed response as soon as possible.
...
TONE: Professional, polite, and responsive

INTENT: Acknowledge receipt of inquiry and inform sender that a response will follow
