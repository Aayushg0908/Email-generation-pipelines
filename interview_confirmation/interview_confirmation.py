...
OUTPUT_CSV = "E:\\Synthetic-Email-Generation-tool-main\\interview_confirmation\\interview_confirmation.csv"
DEBUG_DIR = "E:\\Synthetic-Email-Generation-tool-main\\interview_confirmation\\debug"
LOG_FILE = "E:\\Synthetic-Email-Generation-tool-main\\interview_confirmation\\interview_confirmation_history.log"  # <--- NEW LOG FILE
NUM_EMAILS = 600       
DELAY_SECONDS = 0.1      
MAX_RETRIES = 3          
...
BASE_USER_PROMPT = """Generate a realistic interview confirmation email sent FROM a company TO a candidate.
This email is sent after the candidate has confirmed their interview availability.
...
- Thank the candidate for confirming their interview
- Confirm the interview date, time, and format (virtual or in-person)
- Express that the company looks forward to meeting the candidate
- Do NOT include interview feedback
- Do NOT confirm selection or rejection
- Professional, courteous, ATS-style tone
...
Thank you for confirming your availability for the interview for the Software Engineer position at NovaTech Solutions.

We are pleased to confirm your interview scheduled for Wednesday, 18 September at 10:30 AM. The interview will be conducted via video conference, and joining details will be shared shortly.
...
TONE: Professional, courteous, and welcoming

INTENT: Confirm interview details and acknowledge candidate availability
