...
OUTPUT_CSV = "E:\\Synthetic-Email-Generation-tool-main\\system-notification\\system_notification.csv"
DEBUG_DIR = "E:\\Synthetic-Email-Generation-tool-main\\system-notification\\debug"
LOG_FILE = "E:\\Synthetic-Email-Generation-tool-main\\system-notification\\system_notification_history.log"  # <--- NEW LOG FILE
NUM_EMAILS = 700       
DELAY_SECONDS = 0.1      
MAX_RETRIES = 3          
...
BASE_USER_PROMPT = """Generate a realistic automated system notification email generated by an ATS platform.
This email is an automated system message and is not written by a human recruiter.

CONTEXT:
- The role related to this notification is {role}
- The candidate is described as {adjective}

REQUIREMENTS:
- Do NOT use personal HR names
- Use a system sender identity such as ATS System or Recruitment Platform
- The email must reference an automated system update
- Mention that the system has processed or updated an application record
- Do NOT include conversational language
- Do NOT include emotional or personalized tone
- Do NOT confirm hiring decisions
- Neutral, formal, system-generated tone
- Short, realistic automated notification email
- No double quotes anywhere
- Professional system closing
...
SUBJECT: Application Status Update | Systems Administrator Position

BODY:
This is an automated notification from the TalentTrack Applicant Tracking System.

The application record associated with the Systems Administrator position has been successfully updated in the system. All related data has been processed and logged.

No further action is required at this time. This message was generated automatically.

TalentTrack ATS  
System Notification Service

TONE: Neutral, formal, and system-generated

INTENT: Notify user that an automated system update has been completed
