...
OUTPUT_CSV = "E:\\Synthetic-Email-Generation-tool-main\\interview_feedback\\interview_feedback.csv"
DEBUG_DIR = "E:\\Synthetic-Email-Generation-tool-main\\interview_feedback\\debug"
LOG_FILE = "E:\\Synthetic-Email-Generation-tool-main\\interview_feedback\\interview_feedback_history.log"  # <--- NEW LOG FILE
NUM_EMAILS = 600       
DELAY_SECONDS = 0.1      
MAX_RETRIES = 3          
...
BASE_USER_PROMPT = """Generate a realistic interview feedback follow-up email sent FROM a company TO a candidate.
This email is sent after the candidate has completed an interview.

CONTEXT:
- The interview was for a {role} position
...
- Acknowledge the time and effort the candidate invested
- State that feedback or next steps will be shared later
- Do NOT confirm selection or rejection
- Do NOT mention interview performance details
...
SUBJECT: Thank You for Interviewing | Data Analyst Position

BODY:
Dear Sarah Mitchell,

Thank you for taking the time to interview for the Data Analyst position at Horizon Analytics.

We appreciate the opportunity to learn more about your experience and the effort you put into the interview process. Our team is currently reviewing all discussions and will be in touch regarding next steps.

Thank you again for your interest in joining Horizon Analytics.
...
TONE: Professional, appreciative, and neutral

INTENT: Acknowledge interview completion and inform candidate that feedback will follow
