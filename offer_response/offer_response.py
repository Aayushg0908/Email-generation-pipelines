...
OUTPUT_CSV = "E:\\Synthetic-Email-Generation-tool-main\\offer_response\\offer_response.csv"
DEBUG_DIR = "E:\\Synthetic-Email-Generation-tool-main\\offer_response\\debug"
LOG_FILE = "E:\\Synthetic-Email-Generation-tool-main\\offer_response\\offer_response_history.log"  # <--- NEW LOG FILE
NUM_EMAILS = 600       
DELAY_SECONDS = 0.1      
MAX_RETRIES = 3          
...
BASE_USER_PROMPT = """Generate a realistic offer response acknowledgment email sent FROM a company TO a candidate.
This email is sent after the candidate has responded to a job offer.
...
- Acknowledge receipt of the candidate’s response to the job offer
- Thank the candidate for their timely response
- State that the company will proceed accordingly based on the response
- Do NOT explicitly mention whether the offer was accepted or declined
- Do NOT include onboarding steps or next-day actions
...
SUBJECT: Acknowledgment of Offer Response | Business Analyst Position

BODY:
Dear Jordan Reynolds,

Thank you for your response regarding the offer for the Business Analyst position at Apex Consulting.

We appreciate you taking the time to review the offer details and share your decision. Our team has received your response and will proceed accordingly. Should any additional information be required, a member of our HR team will reach out to you.

Thank you once again for your interest in Apex Consulting.
...
INTENT: Acknowledge receipt of candidate offer response and confirm next steps will follow
